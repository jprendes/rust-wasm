...
export class Stats {
    ...
    */
    get total() {
        const ret = wasm.__wbg_get_stats_total(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} arg0
    */
    set total(arg0) {
        wasm.__wbg_set_stats_total(this.__wbg_ptr, arg0);
    }
    /**
    * @returns {number}
    */
    get count() {
        const ret = wasm.__wbg_get_stats_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} arg0
    */
    set count(arg0) {
        wasm.__wbg_set_stats_count(this.__wbg_ptr, arg0);
    }
}
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_print_c32daf321bd45261 = function(arg0, arg1) {
